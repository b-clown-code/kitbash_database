...
export default function CreatePage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <section>
        <h2 className="text-3xl font-bold mb-2">Submit Compatibility</h2>
        <p className="text-gray-600">
          Add evidence that one part is compatible with another, optionally linking source and target figures.
        </p>
      </section>
